...
def _stub_pcu(monkeypatch: pytest.MonkeyPatch):
    ...
    sys.modules.pop("nre.models.gaussians.utils", None)
...
def test_rgb2sh_torch_at_half_yields_zero():
    ...
    from nre.models.gaussians.utils import RGB2SH
...
def test_rgb2sh_torch_known_value():
    from nre.models.gaussians.utils import C0, RGB2SH
...
def test_write_ply_3dgs_minimal_required_attrs(tmp_path):
    from nre.models.gaussians.utils import write_ply_3dgs
...
def test_write_ply_3dgs_writes_rotation_attrs(tmp_path):
    from nre.models.gaussians.utils import write_ply_3dgs
    import nre.models.gaussians.utils as mod
