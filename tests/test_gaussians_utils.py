...
def _stub_pcu(monkeypatch: pytest.MonkeyPatch):
    ...
    sys.modules.pop("instant_nurec.models.gaussians.utils", None)
...
def test_rgb2sh_torch_at_half_yields_zero():
    ...
    from instant_nurec.models.gaussians.utils import RGB2SH
...
def test_rgb2sh_torch_known_value():
    from instant_nurec.models.gaussians.utils import C0, RGB2SH
...
def test_write_ply_3dgs_minimal_required_attrs(tmp_path):
    from instant_nurec.models.gaussians.utils import write_ply_3dgs
...
def test_write_ply_3dgs_writes_rotation_attrs(tmp_path):
    from instant_nurec.models.gaussians.utils import write_ply_3dgs
    import instant_nurec.models.gaussians.utils as mod
