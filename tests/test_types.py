...
def test_frameconversion_post_init_accepts_identity():
    from instant_nurec._pkg.utils.types import FrameConversion
...
def _make_rig_trajectories(camera_ids, lidar_ids, traj_camera_ids=None, traj_lidar_ids=None):
    ...
    import torch
    from instant_nurec._pkg.utils.types import FrameConversion, RigTrajectories
...
def _make_tracks_data(n_tracks=2, n_poses_per_track=3, **overrides):
    import torch
    from instant_nurec._pkg.utils.types import TracksData
...
def test_cuboid_tracks_data_post_init_accepts_valid_inputs():
    import torch
    from instant_nurec._pkg.utils.types import CuboidTracksData
...
def test_cuboid_tracks_data_pack_post_init_accepts_matching_n_tracks():
    import torch
    from instant_nurec._pkg.utils.types import CuboidTracksData, CuboidTracksDataPack
...
def test_track_flags_none_is_zero():
    from instant_nurec._pkg.utils.types import TrackFlags
