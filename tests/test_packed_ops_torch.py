...
def test_packed_searchsorted_use_case_from_interpolate_tracks_poses():
    """End-to-end shape check matching tracks.py:393.

    Three tracks, each with 4 keyframes; flatten gives 12 timestamps.
    Query 5 random points across the 3 tracks; verify the kernel-equivalent
    semantics produce sensible right-indices.
    """
    bins = torch.tensor(
