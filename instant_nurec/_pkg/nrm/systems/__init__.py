...
from instant_nurec._pkg.nrm.systems.gaussians_nrm import GaussiansNRMSystem
...
def make(config: "NRMConfig", load_from_checkpoint: Optional[str] = None) -> GaussiansNRMSystem:
    ...
    if full_pt_path and os.path.exists(full_pt_path):
        ...
        from instant_nurec._pkg.nrm.datasets.datamodule import NRMDataModule  # local to avoid bootstrap loops
