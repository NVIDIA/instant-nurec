...
"""Branch-coverage tests for instant_nurec.model.blocks.attention.
...
from instant_nurec_internal.model.blocks.attention import (
    AttentionBlock,
    CrossAttention,
    CrossAttentionBlock,
...
from instant_nurec_internal.model.blocks.layers import LayerScale
