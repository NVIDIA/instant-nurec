...
class Quat(_message.Message):
    ...
    z: float
    def __init__(
        self, w: _Optional[float] = ..., x: _Optional[float] = ..., y: _Optional[float] = ..., z: _Optional[float] = ...
    ) -> None: ...
...
class Pose(_message.Message):
    ...
    quat: Quat
    def __init__(
        self, vec: _Optional[_Union[Vec3, _Mapping]] = ..., quat: _Optional[_Union[Quat, _Mapping]] = ...
    ) -> None: ...
...
class DynamicState(_message.Message):
    ...
    def __init__(
        self,
        angular_velocity: _Optional[_Union[Vec3, _Mapping]] = ...,
        linear_velocity: _Optional[_Union[Vec3, _Mapping]] = ...,
    ) -> None: ...
...
class AABB(_message.Message):
    ...
    size_z: float
    def __init__(
        self, size_x: _Optional[float] = ..., size_y: _Optional[float] = ..., size_z: _Optional[float] = ...
    ) -> None: ...
...
class StateAtTime(_message.Message):
    ...
    def __init__(
        ...
        state: _Optional[_Union[DynamicState, _Mapping]] = ...,
    ) -> None: ...
...
class VersionId(_message.Message):
    ...
    def __init__(
        ...
        git_hash: _Optional[str] = ...,
        grpc_api_version: _Optional[_Union[VersionId.APIVersion, _Mapping]] = ...,
    ) -> None: ...
